...
public class Operator {
    public  static  void main(String[] args){
        ...
        System.out.println(hour + "초는");
        System.out.println(minute + "분, 36");
        ...
        System.out.println("하나의 긴 문자열을 표현하기 외해서는 String 타입의 변수에 긴 문자열을 저장하여 출력");

        System.out.println("여러개의 문자열 변수에 저장된 내용을 한줄로 표현하고 싶을 경우 사용하는 것이 문자열 연결 연산자");

        String str1 = "String 타입의 변수에 긴 문자열을 입력하여 printIn() 함수를 통해서 화면에 출려";
        System.out.println(str1);

        System.out.println("2개 이상의 " + "문자열을 +연사자를 사용하여 "+ "연산을 진행하면 " + "하느의 긴 문자열로 출력 됨");
        ...
        // ()안에 있는 데티어를 먼저 연산
        // 연산자의 우선 순위 때문에 왼쪽부터 차례대로 연산을 진행하여 문자열과 순자(6500)의 연산이 먼저 발생하고, 그이후에 문자열과 두번째 순자(2000)과의 연산이 발생하여 로세티리 바베큐 세트 65002000원  이라는 형태로 결과를 나타냄


        System.out.println("-----------증감 연산자 ------------");

        // 전위연산 혹은 후위 연산이 단독으로 사용될 경우에는 일반 연산자를 통해서 값을 증감 시키는 것과 차이가 없음
        // 전위 연산 혹은 후위 연산을 다른 연산식과 함께 사용할 경우 실행되는 시점이 달라짐
        int op =10;
        System.out.println("변수 op의 값 :" +op);
        op++;
        System.out.println("변수 op++ 이후의 값 :" +op);
        ++op;
        System.out.println("변수 ++op의 값 :" +op);
        --op;
        System.out.println("변수 --op의 값 :" +op);
